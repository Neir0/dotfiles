...
_G.packer_plugins = {
  ...
  ["nvim-treesitter-angular"] = {
    loaded = true,
    path = "/Users/jveiga/.local/share/nvim/site/pack/packer/start/nvim-treesitter-angular",
  ...
  ["onenord.nvim"] = {
    config = { 'require("config/onenord")' },
    loaded = true,
    path = "/Users/jveiga/.local/share/nvim/site/pack/packer/start/onenord.nvim",
  ...
  playground = {
    loaded = true,
    path = "/Users/jveiga/.local/share/nvim/site/pack/packer/start/playground",
